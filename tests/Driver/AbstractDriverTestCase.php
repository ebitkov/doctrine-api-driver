 ...
 * https://github.com/doctrine/dbal/blob/3.8.x/tests/Driver/AbstractDriverTestCase.php
 *
...
abstract class AbstractDriverTestCase extends TestCase
{
    ...
    /**
     * Factory method for creating the platform instance return by the driver under test.
     *
    ...
    /**
     * Factory method for creating the schema manager instance return by the driver under test.
     *
